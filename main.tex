...
\author{Eric Fernandes Evaristo, Antônio Augusto Medeiros Frölich}
...
\begin{itemize}
    \item Present an analysis of the most relevant hardware and software performance metrics for real-time scheduling;
